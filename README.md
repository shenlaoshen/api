...
```bash
https://jin18.nazimay.filegear-sg.me?config=0&encode=base58
```
```bash
https://raw.githubusercontent.com/shenlaoshen/api/refs/heads/main/jin18.txt
```
👉 Base58编码订阅链接[精简版🎬+🔞源链接](https://jin18.nazimay.filegear-sg.me?config=0&encode=base58) （推荐使用自己部署的代理）精简版剔除无搜索结果和污染搜索结果源                             
```bash
https://jin18.nazimay.filegear-sg.me?config=0&encode=base58
```
```bash
...
| 🚨 | 🔞-幸资源- | https://xzybb2.com/api.php/provide/vod | 40 | 60 | 40.0% | 60 |
